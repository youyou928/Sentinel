...
angular.module("sentinelDashboardApp", ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog", "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard", "selectize", "angularUtils.directives.dirPagination"]).factory("AuthInterceptor", ["$window", "$state", function (r, t) {
	...
	}).state("dashboard.flowEx", {
		templateUrl: "app/views/flow_v1.html",
		url: "/flow/ex/:app",
		controller: "FlowControllerEx",
		resolve: {
			loadMyFiles: ["$ocLazyLoad", function (e) {
				return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/ex/flow_ex.js"]})
			}]
		}
	...
	}).state("dashboard.paramFlowEx", {
		templateUrl: "app/views/param_flow.html",
		url: "/paramFlow/ex/:app",
		controller: "ParamFlowControllerEx",
		resolve: {
			loadMyFiles: ["$ocLazyLoad", function (e) {
				return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/ex/param_flow_ex.js"]})
			}]
		}
	...
	}).state("dashboard.authorityEx", {
		templateUrl: "app/views/authority.html",
		url: "/authority/ex/:app",
		controller: "AuthorityRuleControllerEx",
		resolve: {
			loadMyFiles: ["$ocLazyLoad", function (e) {
				return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/ex/authority_ex.js"]})
			}]
		}
	...
	}).state("dashboard.degradeEx", {
		templateUrl: "app/views/degrade.html",
		url: "/degrade/ex/:app",
		controller: "DegradeCtlEx",
		resolve: {
			loadMyFiles: ["$ocLazyLoad", function (e) {
				return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/ex/degrade_ex.js"]})
			}]
		}
	...
	}).state("dashboard.systemEx", {
		templateUrl: "app/views/system.html",
		url: "/system/ex/:app",
		controller: "SystemCtlEx",
		resolve: {
			loadMyFiles: ["$ocLazyLoad", function (e) {
				return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/ex/system_ex.js"]})
			}]
		}
	...
	}).state("dashboard.identityEx", {
		templateUrl: "app/views/identity.html",
		url: "/identity/:app",
		controller: "IdentityCtlEx",
		resolve: {
			loadMyFiles: ["$ocLazyLoad", function (e) {
				return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/ex/identity_ex.js"]})
			}]
		}
...
}]), (app = angular.module("sentinelDashboardApp")).service("FlowServiceEx", ["$http", function (a) {
	function t(e) {
		return void 0 === e || "" === e || isNaN(e) || e <= 0
	}

	this.queryMachineRules = function (e, t, r) {
		return a({url: "/flow/ex/rules", params: {app: e, ip: t, port: r}, method: "GET"})
	}, this.newRule = function (e) {
		e.resource, e.limitApp, e.grade, e.count, e.strategy, e.refResource, e.controlBehavior, e.warmUpPeriodSec, e.maxQueueingTimeMs, e.app, e.ip, e.port;
		return a({url: "/flow/ex/rule", data: e, method: "POST"})
	}, this.saveRule = function (e) {
		var t = {
			id: e.id,
			resource: e.resource,
		...
		return a({url: "/flow/ex/save.json", params: t, method: "PUT"})
	}, this.deleteRule = function (e) {
		var t = {id: e.id, app: e.app};
		return a({url: "/flow/ex/delete.json", params: t, method: "DELETE"})
	}, this.checkRuleValid = function (e) {
		return void 0 === e.resource || "" === e.resource ? (alert("资源名称不能为空"), !1) : void 0 === e.count || e.count < 0 ? (alert("限流阈值必须大于等于 0"), !1) : void 0 === e.strategy || e.strategy < 0 ? (alert("无效的流控模式"), !1) : 1 != e.strategy && 2 != e.strategy || void 0 !== e.refResource && "" != e.refResource ? void 0 === e.controlBehavior || e.controlBehavior < 0 ? (alert("无效的流控整形方式"), !1) : 1 == e.controlBehavior && t(e.warmUpPeriodSec) ? (alert("预热时长必须大于 0"), !1) : 2 == e.controlBehavior && t(e.maxQueueingTimeMs) ? (alert("排队超时时间必须大于 0"), !1) : !e.clusterMode || void 0 !== e.clusterConfig && void 0 !== e.clusterConfig.thresholdType || (alert("集群限流配置不正确"), !1) : (alert("请填写关联资源或入口"), !1)
	}
...
}]), (app = angular.module("sentinelDashboardApp")).service("DegradeServiceEx", ["$http", function (a) {
	this.queryMachineRules = function (e, t, r) {
		return a({url: "degrade/ex/rules.json", params: {app: e, ip: t, port: r}, method: "GET"})
	}, this.newRule = function (e) {
		return a({url: "/degrade/ex/rule", data: e, method: "POST"})
	}, this.saveRule = function (e) {
		var t = {
			id: e.id,
			resource: e.resource,
		...
		return a({url: "/degrade/ex/rule/" + e.id, data: t, method: "PUT"})
	}, this.deleteRule = function (e) {
		return a({url: "/degrade/ex/rule/" + e.id, method: "DELETE"})
	}, this.checkRuleValid = function (e) {
		if (void 0 === e.resource || "" === e.resource) return alert("资源名称不能为空"), !1;
		if (void 0 === e.grade || e.grade < 0) return alert("未知的降级策略"), !1;
		if (void 0 === e.count || "" === e.count || e.count < 0) return alert("降级阈值不能为空或小于 0"), !1;
...
}]), (app = angular.module("sentinelDashboardApp")).service("SystemServiceEx", ["$http", function (a) {
	this.queryMachineRules = function (e, t, r) {
		return a({url: "system/ex/rules.json", params: {app: e, ip: t, port: r}, method: "GET"})
	}, this.newRule = function (e) {
		var t = {app: e.app, ip: e.ip, port: e.port};
		return 0 == e.grade ? t.highestSystemLoad = e.highestSystemLoad : 1 == e.grade ? t.avgRt = e.avgRt : 2 == e.grade ? t.maxThread = e.maxThread : 3 == e.grade ? t.qps = e.qps : 4 == e.grade && (t.highestCpuUsage = e.highestCpuUsage), a({
			url: "/system/ex/new.json",
			params: t,
			method: "GET"
		})
	}, this.saveRule = function (e) {
		var t = {id: e.id};
		return 0 == e.grade ? t.highestSystemLoad = e.highestSystemLoad : 1 == e.grade ? t.avgRt = e.avgRt : 2 == e.grade ? t.maxThread = e.maxThread : 3 == e.grade ? t.qps = e.qps : 4 == e.grade && (t.highestCpuUsage = e.highestCpuUsage), a({
			url: "/system/ex/save.json",
			params: t,
			method: "GET"
		})
	}, this.deleteRule = function (e) {
		var t = {id: e.id, app: e.app};
		return a({url: "/system/ex/delete.json", params: t, method: "GET"})
	}
...
}]), angular.module("sentinelDashboardApp").service("ParamFlowServiceEx", ["$http", function (a) {
	function o(e) {
		return !("int" !== (r = e.classType) && "double" !== r && "float" !== r && "long" !== r && "short" !== r || void 0 !== (t = e.object) && "" !== t && !isNaN(t)) || (!!("byte" === e.classType && (a = e.object, o = -128, l = 127, void 0 === a || "" === a || isNaN(a) || a < o || l < a)) || (void 0 === e.object || void 0 === e.classType || (void 0 === (n = e.count) || "" === n || isNaN(n) || n < 0)));
		var t, r, a, o, l, n
	}
	...
	this.queryMachineRules = function (e, t, r) {
		return a({url: "/paramFlow/ex/rules", params: {app: e, ip: t, port: r}, method: "GET"})
	}, this.addNewRule = function (e) {
		return a({url: "/paramFlow/ex/rule", data: e, method: "POST"})
	}, this.saveRule = function (e) {
		return a({url: "/paramFlow/ex/rule/" + e.id, data: e, method: "PUT"})
	}, this.deleteRule = function (e) {
		return a({url: "/paramFlow/ex/rule/" + e.id, method: "DELETE"})
	}, this.checkRuleValid = function (e) {
		if (!e.resource || "" === e.resource) return alert("资源名称不能为空"), !1;
		if (1 != e.grade) return alert("未知的限流模式"), !1;
		if (e.count < 0) return alert("限流阈值必须大于等于 0"), !1;
...
}]), angular.module("sentinelDashboardApp").service("AuthorityRuleServiceEx", ["$http", function (a) {
	this.queryMachineRules = function (e, t, r) {
		return a({url: "/authority/ex/rules", params: {app: e, ip: t, port: r}, method: "GET"})
	}, this.addNewRule = function (e) {
		return a({url: "/authority/ex/rule", data: e, method: "POST"})
	}, this.saveRule = function (e) {
		return a({url: "/authority/ex/rule/" + e.id, data: e, method: "PUT"})
	}, this.deleteRule = function (e) {
		return a({url: "/authority/ex/rule/" + e.id, method: "DELETE"})
	}, this.checkRuleValid = function (e) {
		return void 0 === e.resource || "" === e.resource ? (alert("资源名称不能为空"), !1) : void 0 === e.limitApp || "" === e.limitApp ? (alert("流控针对应用不能为空"), !1) : void 0 !== e.strategy || (alert("必须选择黑白名单模式"), !1)
	}
