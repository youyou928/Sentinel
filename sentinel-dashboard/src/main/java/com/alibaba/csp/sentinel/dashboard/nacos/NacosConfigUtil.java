...
public final class NacosConfigUtil {
    ...
    public static final String DEGRADE_DATA_ID_POSTFIX = "-degrade-rule.json";
    public static final String SYSTEM_DATA_ID_POSTFIX = "-system-rule.json";
    public static final String AUTHORITY_DATA_ID_POSTFIX = "-authority-rule.json";
