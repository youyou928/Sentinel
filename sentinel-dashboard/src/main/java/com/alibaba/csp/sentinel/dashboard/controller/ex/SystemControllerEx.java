 ...
 */
package com.alibaba.csp.sentinel.dashboard.controller.ex;
...
public class SystemControllerEx {

    private final Logger logger = LoggerFactory.getLogger(SystemControllerEx.class);
    ...
    @Autowired
    @Qualifier("systemFlowRuleNacosProvider")
    private DynamicRuleProvider<List<SystemRuleEntity>> ruleProvider;
    @Autowired
    @Qualifier("systemFlowRuleNacosPublisher")
