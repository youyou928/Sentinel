 ...
 */
@RestController
@RequestMapping(value = "/authority/ex")
public class AuthorityRuleControllerEx {

    private final Logger logger = LoggerFactory.getLogger(AuthorityRuleControllerEx.class);
