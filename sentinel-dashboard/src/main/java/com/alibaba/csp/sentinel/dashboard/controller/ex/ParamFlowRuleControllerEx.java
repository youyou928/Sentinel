 ...
 */
@RestController
@RequestMapping(value = "/paramFlow/ex")
public class ParamFlowRuleControllerEx {

    private final Logger logger = LoggerFactory.getLogger(ParamFlowRuleControllerEx.class);
